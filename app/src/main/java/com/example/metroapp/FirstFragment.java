...
public class FirstFragment extends Fragment {
    ...
    private void initViews() {
        ...
        res=getResources();
        s=res.getStringArray(R.array.first_line);
        for(String x:s){
          station.add(x);
        }
    ...
    class StaionsAdapter extends RecyclerView.Adapter<StaionsAdapter.StaionsVH>{
        ...
        @NonNull
        @Override
        public StaionsVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view=LayoutInflater.from(getContext()).inflate(R.layout.item,parent,false);
            return new StaionsVH(view);
        }

        @Override
        public void onBindViewHolder(@NonNull StaionsVH holder, int position) {
